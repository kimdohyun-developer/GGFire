...
output_file = "/content/★활동 세부내역_분류.xlsx"
target_sheet = "temp"
...
with pd.ExcelWriter(output_file, engine="openpyxl") as writer:
    for index, item in enumerate(unique_items_array):
        ...
        title_cell.font = Font(name="맑은 고딕", size=17, bold=True, color="FFFFFF")
...
print(
    f"\n🎉 안쪽 기본 격자 및 외곽 가장자리 굵은 선 마감 완벽 반영! 최종 파일 확인: {output_file}"
)
